...
from weather_providers.weather_provider_strategy import WeatherProviderStrategy, ForecastPeriod, WeatherData
...
def return_current_weather_data(weather_provider: WeatherProviderStrategy, city_name: str,
    ...
    try:
        ...
        logger.error(f"Failed to fetch weather data for city: '{city_name}' and weather provider "
                     f"'{weather_provider.provider_name}'")
...
def compile_current_weather_output(weather_provider: WeatherProviderStrategy, city_name: str) -> str:
    ...
    weather_data, needs_cache_update = return_current_weather_data(weather_provider=weather_provider,
                                                                   city_name=city_name,
